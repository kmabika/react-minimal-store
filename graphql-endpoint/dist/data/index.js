...
var shoeSizes = new attribute_set_1.default('Size').addItemList([
  new attribute_1.default('40'),
  new attribute_1.default('41'),
  new attribute_1.default('42'),
  new attribute_1.default('43'),
]);
var clothesSizes = new attribute_set_1.default('Size').addItemList([
...
var capacity = new attribute_set_1.default('Capacity').addItemList([
...
var products = [
  ...
  new product_1.default('iMac 2021')
    ...
    .addAttributeSet(
      new attribute_set_1.default('Capacity')
