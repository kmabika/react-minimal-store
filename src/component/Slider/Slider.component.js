...
export class Slider extends PureComponent {
  ...
  handleNextSlide() {
    ...
    this.setState(state => {
      return {
        activeSlide: state.activeSlide < images.length - 1 ? state.activeSlide + 1 : images.length - 1,
        translate: state.translate < 100 - widthSlide ? state.translate + widthSlide : 100 - widthSlide,
      };
    });
  }
